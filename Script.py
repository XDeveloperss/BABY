...
നിങ്ങൾക്ക് അവശമുള്ള മൂവി ഇവിടെ സെർച്ച് ചെയ്യാം 
 ...
 ɴʙ: ഡിവിഡി ഇറങ്ങിയ മൂവീസ് മാത്രേ ലഭിക്കു😜"""
    MOVIE_KITTAN = """𝙷𝙴𝙻𝙾 {},
പുതിയ മൂവികൾ ആദ്യത്തെ ബട്ടനിൽ ഞെക്കിയാൽ ലഭിക്കുന്നതാണ്😃"""
    MFK_1 = """𝙷𝙴𝙻𝙾 {},
𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂, 
 ഞാൻ ഒരു ഓപ്പൺ സോഴ്സ് ബോട്ടാണ്😍"""
    CMD_LIST = """𝙷𝙴𝙻𝙾 {},
...
➪ മറ്റു ചാനലുകളെ അപേക്ഷിച്ചു മെയിൻ ചാനലിന് കോപ്പിറൈറ് വരുന്നതിനുള്ള സാധ്യയത കുറവാരിക്കും 😀"""
    START_TXT = """Hᴇʏ {}{},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>, I ᴀᴍ ᴊᴜsᴛ ᴀɴ ᴀᴅᴠᴀɴᴄᴇᴅ Aᴜᴛᴏғɪʟᴛᴇʀ Bᴏᴛ Wɪᴛʜ ᴇxᴛʀᴀ ᴄᴀᴘᴀʙɪʟɪᴛɪᴇs.Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀs ᴀᴅᴍɪɴ ᴀɴᴅ I'ʟʟ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ᴛʜᴇʀᴇ 😍
